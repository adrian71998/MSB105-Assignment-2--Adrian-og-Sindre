...
#| fig-cap: "Histogram som viser fordeling av inntekt i populasjonen til datasettet"
heightsNormInc %>%
ggplot(aes(
  x = income)
  ) +
...
#| fig-cap: "Histogram som viser fordeling av høyde i populasjonen til datasettet"
heightsNormInc %>%
  ggplot(
    mapping = aes(
      x = height
...
#| fig-cap: "Korrelasjon mellom høyde og inntekt"
# ønsker å bruke pairs for å sammenligne inntekt og høyde
...
#| fig-cap: "Boksplot av inntekt mot ekteskap. Modellen er splittet på kjonn og viser menn til venstre, og kvinner til høyre. Det kan virke som det er en positiv sammenheng mellom inntekt og ekteskap både for kvinner og menn, men sterkest for menn"
